#!/bin/bash
#SBATCH --job-name VKDNW_EVOLUTION_FLOPS520M_LAYERS14_PARAMS_RANDOM_FIXED
...
save_dir=/mnt/proj2/open-30-33/zico_karolina/VKDNW_EVOLUTION_FLOPS520M_LAYERS14_PARAMS_RANDOM_FIXED_50ep
mkdir -p ${save_dir}
...
horovodrun -np 8 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/VKDNW_EVOLUTION_FLOPS520000000_LAYERS14_PARAMS_RANDOM_FIXED.txt \
