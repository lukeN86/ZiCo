#!/bin/bash
#SBATCH --job-name VKDNW_EVOLUTION_FLOPS520M_LAYERS14_PARAMS_RANDOM_FIXED_TOP4
...
horovodrun -np 8 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/VKDNW_EVOLUTION_FLOPS520000000_LAYERS14_PARAMS_RANDOM_FIXED_TOP4.txt \
