#!/bin/bash
#SBATCH --job-name NEVERGRAD_NgIohTuned_L18_a
...
save_dir=/mnt/proj2/open-30-33/zico/NEVERGRAD_NgIohTuned_L18_a_150ep
mkdir -p ${save_dir}
...
horovodrun -np 16 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/NEVERGRAD_NgIohTuned_L18_a.txt \
