#!/bin/bash
#SBATCH --job-name VKDNW_EVOLUTION_FLOPS_1050M_14L_480ep
...
save_dir=/mnt/proj2/open-30-33/zico/VKDNW_EVOLUTION_FLOPS_1050M_14L_480ep
mkdir -p ${save_dir}
...
horovodrun -np 16 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/VKDNW_EVOLUTION_FLOPS_1050M_14L.txt \
