#!/bin/bash
#SBATCH --job-name=VKDNW_EVOLUTION_FLOPS450000000_LAYERS14_PARAMS_RANDOM_FIXED
...
save_dir=./save_dir/VKDNW_EVOLUTION_FLOPS450000000_LAYERS14_PARAMS_RANDOM_FIXED_ImageNet_50ep
mkdir -p ${save_dir}
...
horovodrun -np 4 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/VKDNW_EVOLUTION_FLOPS450000000_LAYERS14_PARAMS_RANDOM_FIXED.txt \
