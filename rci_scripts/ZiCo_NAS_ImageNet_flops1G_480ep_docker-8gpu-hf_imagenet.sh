...
save_dir=./save_dir/ZiCo_NAS_ImageNet_flops1G_480ep_docker_8gpu_hfimagenet
mkdir -p ${save_dir}
...
singularity exec --nv --bind /mnt:/mnt docker://luken86/aznas horovodrun -np 8 python ts_train_image_classification.py --dataset hf_imagenet --num_classes 1000 \
