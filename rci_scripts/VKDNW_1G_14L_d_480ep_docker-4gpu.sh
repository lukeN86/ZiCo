#!/bin/bash
#SBATCH --job-name=VKDNW_1G_14L_d
...
save_dir=./save_dir/VKDNW_1G_14L_d_480ep_docker_4gpu
mkdir -p ${save_dir}
...
singularity exec --nv --bind /mnt:/mnt docker://luken86/aznas horovodrun -np 4 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/VKDNW_1G_14L_d.txt \
