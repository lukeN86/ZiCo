#!/bin/bash
#SBATCH --job-name=TOP_vkdnw_b_flops480M_layers18
...
save_dir=./save_dir/TOP_vkdnw_b_flops480M_layers18_ImageNet_50ep
mkdir -p ${save_dir}
...
horovodrun -np 4 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/TOP_vkdnw_b_flops480M_layers18.txt \
