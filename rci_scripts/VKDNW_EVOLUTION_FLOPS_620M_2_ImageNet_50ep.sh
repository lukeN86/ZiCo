#!/bin/bash
#SBATCH --job-name=VKDNW_EVOLUTION_FLOPS_620M_2
...
save_dir=./save_dir/VKDNW_EVOLUTION_FLOPS_620M_2_ImageNet_50ep_b3
mkdir -p ${save_dir}
...
horovodrun -np 4 python ts_train_image_classification.py --dataset imagenet --num_classes 1000 \
  ...
  --plainnet_struct_txt ZiCo/VKDNW_EVOLUTION_FLOPS_620M_2.txt \
